		...
		>
			...
			>
				<p className="text-[#C9BCAF] font-medium text-2xl text-center">
					...
					продукт. */}
					Мы превращаем натуральный песок и мраморную крошку в современные композитные материалы. Это — подлинная красота и фактура природных элементов, воплощённые в технологичных решениях для любого проекта.
Наша философия — сохранять и преумножать эстетику естественного мира. Используя натуральный песок, мраморную крошку и инновационные связующие, мы производим композитные материалы, которые открывают новые возможности в дизайне интерьеров, фасадов и ландшафтов. От декоративных панелей до напольных покрытий — каждое наше решение это диалог между природой и прогрессом.
				</p>
			</motion.div>
			<motion.svg
				initial={{ opacity: 0, scale: 0 }}
