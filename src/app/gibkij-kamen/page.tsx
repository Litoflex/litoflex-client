        ...
        <section className="catalogue" style={{ paddingTop: '2.5rem' }}>
          <div className="section-container">
            ...
            <p style={{ fontSize: '1.05rem', lineHeight: 1.7, color: 'var(--gray-700)', maxWidth: '900px', margin: '0 0 2.5rem' }}>
              ООО «Литофлекс» — производитель гибкого камня в Минске. Гибкий камень — это тонкий облицовочный материал из натуральной мраморной крошки на гибкой основе: он повторяет фактуру и цвет настоящего камня, но весит в разы меньше и легко монтируется как на фасад здания, так и на стены внутри помещения. Продаём напрямую от производителя, без посредников — цена от 28 <BynSymbol /> за модуль, доставка по всей Беларуси.
            </p>
            ...
            <p style={{ fontSize: '1rem', lineHeight: 1.7, color: 'var(--gray-700)', maxWidth: '900px', margin: '0 0 1rem' }}>
              Гибкий камень делают из натуральной мраморной крошки: её равномерно наносят на эластичную основу из стеклохолста и фиксируют полимерным связующим. Сохраняются природный цвет и фактура камня, при этом листы из одной партии имеют единый рисунок — фасад получается однородным, без пёстрых стыков, а при необходимости легко докупить материал из той же партии. Толщина листа всего 1,5–2 мм, поэтому материал гнётся и облицовывает не только ровные стены, но и колонны, арки, углы и другие сложные поверхности, где обычная плитка или натуральный камень не подойдут.
            </p>
            ...
            <ul style={{ fontSize: '1rem', lineHeight: 1.8, color: 'var(--gray-700)', maxWidth: '900px', margin: '0 0 2.5rem', paddingLeft: '1.25rem' }}>
              <li><strong>Натуральный камень, а не имитация.</strong> Это натуральная мраморная крошка, а не напечатанная имитация — фактура и цвет природные.</li>
            ...
            <div className="products-grid">
              {stoneProducts.map((product) => (
                <article
                  ...
                  onClick={() => setSelectedProduct({ ...product, category: 'stone' })}
                >
