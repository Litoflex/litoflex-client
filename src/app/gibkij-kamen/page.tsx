        ...
        <section className="catalogue" style={{ paddingTop: '2.5rem' }}>
          <div className="section-container">
            ...
            <p style={{ fontSize: '1.05rem', lineHeight: 1.7, color: 'var(--gray-700)', maxWidth: '900px', margin: '0 0 2.5rem' }}>
              ООО «Литофлекс» — производитель гибкого камня в Минске. Гибкий камень — его также называют гибким мрамором — это тонкий облицовочный материал из натуральной мраморной крошки на гибкой основе: он повторяет фактуру и цвет настоящего камня, но весит в разы меньше и легко монтируется как на фасад здания, так и на стены внутри помещения. Продаём напрямую от производителя, без посредников — цена от 28 <BynSymbol /> за модуль, доставка по всей Беларуси.
            </p>
