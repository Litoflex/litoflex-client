...
export const metadata: Metadata = {
  ...
  description: 'Гибкий кирпич для фасада и интерьера от производителя в Минске. Цена от 30 Б за модуль, доставка по всей Беларуси. Лёгкая и гибкая альтернатива клинкерному кирпичу.',
  keywords: [
    'гибкий кирпич',
    'гибкий кирпич Минск',
  ...
  openGraph: {
    title: 'Гибкий кирпич в Минске — купить от производителя | ЛитоФлекс',
    description: 'Гибкий кирпич для фасада и интерьера от производителя в Минске. Цена от 30 Б за модуль, доставка по всей Беларуси.',
