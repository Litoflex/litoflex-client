    ...
    <>
      ...
      <main id="main">
        ...
        <section className="hero">
          ...
          <div className="hero-content">
            <div className="hero-text">
              ...
              <p className="hero-description">Натуральный песок и мраморная крошка в современных композитных материалах. Подлинная красота природы в технологичных решениях для любого проекта.</p>
              <div className="hero-mobile-promo">
                <span className="hero-mobile-promo-badge">Весенняя акция</span>
                <span className="hero-mobile-promo-number">−20%</span>
                <span className="hero-mobile-promo-desc">на всю продукцию до <span className="hero-promo-date">15 апреля</span></span>
              </div>
            ...
            <div className="hero-visual">
              <div className="hero-promo-card">
                <div className="hero-promo-content">
                  <div className="hero-promo-badge">Весенняя акция</div>
                  <div className="hero-promo-discount">
                    <span className="hero-promo-number">−20%</span>
                  </div>
                  <p className="hero-promo-desc">на всю продукцию до <span className="hero-promo-date">15 апреля</span></p>
                  <a href="#catalogue" className="hero-promo-btn">Смотреть каталог →</a>
                </div>
                <div className="hero-promo-stats">
        ...
        <section className="gallery" id="gallery">
          <div className="section-container">
            <header className="section-header animate-on-scroll">
              <div className="section-tag">Примеры</div>
            ...
            <div className="gallery-grid animate-on-scroll">
              {[
                ...
                >
                  <img src={photo.src} alt={`Гибкий кирпич ${photo.label}`} loading="lazy" />
