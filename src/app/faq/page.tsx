...
const faqData = [
  {
    ...
    questions: [
      ...
      {
        q: "Из чего производится гибкий камень LITOFLEX?",
      ...
      },
      {
        ...
        a: "Срок службы гибкого камня LITOFLEX составляет более 30 лет при правильном монтаже и минимальном уходе. Материал устойчив к ультрафиолету, не выгорает на солнце и сохраняет свой первоначальный вид на протяжении всего срока эксплуатации."
      },
      {
        q: "Безопасен ли гибкий камень для здоровья?",
        a: "Да, полностью безопасен. Гибкий камень LITOFLEX изготовлен из натуральных компонентов — песка и мраморной крошки. Он не выделяет вредных веществ, не имеет запаха и гипоаллергенен. Материал имеет все необходимые сертификаты качества и безопасности. Подходит для использования в жилых помещениях, включая детские комнаты."
      },
      {
        q: "Чем гибкий камень отличается от гибкого кирпича?",
        a: "Это два разных продукта LITOFLEX, отличающихся текстурой и внешним видом. Гибкий камень имитирует натуральный песчаник или сланец с природным рисунком. Гибкий кирпич имитирует кирпичную кладку с характерной прямоугольной формой. Оба материала имеют одинаковые технические характеристики и способ монтажа."
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        a: "Гибкий камень LITOFLEX выдерживает экстремальные температуры: от -60°C до +150°C. Это делает его идеальным материалом для наружной отделки в белорусском климате, а также для облицовки каминов и печей."
      },
      {
      ...
      },
      {
        ...
        a: "Гибкий камень LITOFLEX весит всего 2–4 кг на квадратный метр. Для сравнения: натуральный камень весит 30–50 кг/м², а клинкерный кирпич — 20–30 кг/м². Благодаря малому весу гибкий камень не создаёт нагрузки на фасад и фундамент, и его можно монтировать на любые поверхности без дополнительного усиления."
      },
      {
        q: "Какие размеры модуля гибкого камня?",
        a: "Стандартный размер модуля гибкого камня LITOFLEX — 950×550 мм. Материал легко режется обычными ножницами или строительным ножом, что позволяет подогнать его под любые размеры и формы при монтаже."
      },
      {
  ...
  },
  {
    ...
    questions: [
      {
        q: "Сколько стоит гибкий камень LITOFLEX?",
        a: "Цена на гибкий камень LITOFLEX начинается от 45 BYN за квадратный метр. Гибкий кирпич — от 52 BYN/м². Точная стоимость зависит от выбранной текстуры и объёма заказа. Для крупных заказов предусмотрены скидки. Актуальные цены — в нашем каталоге на сайте."
      },
      {
      ...
      },
      {
        ...
        a: "Да, мы предоставляем гарантию на всю продукцию LITOFLEX. Наш гибкий камень сертифицирован и прошёл все необходимые испытания. Сертификаты качества доступны на нашем сайте в разделе «Сертификаты»."
      }
    ]
  },
  {
    ...
    <div style={{ minHeight: "100vh", background: "#1A2238", color: "#fff" }}>
      ...
      <div style={{ padding: "80px 20px 40px", textAlign: "center", maxWidth: "800px", margin: "0 auto" }}>
        ...
        <p style={{
          ...
          Ответы на самые популярные вопросы о продукции LITOFLEX — от характеристик материала до монтажа и доставки
        </p>
      </div>
